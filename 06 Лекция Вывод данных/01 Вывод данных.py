...
# Также после команды print() по умолчанию происходит перенос на новую строчку.
# За этот перенос отвечает еще один параметр, который называется end.
# Он по умолчанию равен \n - это служебный символ, обозначающий перенос строки.
print(1,2,3)
print('hello',end='\n')
print(5,6,7)
