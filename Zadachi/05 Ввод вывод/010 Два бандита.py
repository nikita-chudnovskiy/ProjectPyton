...
#Ларри — с самой правой. В какой-то момент получилось так, что они одновременно
...
# Входные 4 и 7 Выходные 6 и 3
bankiGari ,bankiLari = map(int,input().split())
banki = bankiGari+bankiLari-1
print(banki-bankiGari,banki-bankiLari)