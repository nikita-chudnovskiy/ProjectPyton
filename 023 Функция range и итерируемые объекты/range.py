...
# Что такое итерируемый объект - это объект который способен возвращать элементы по одному

# Объект который возвращает функция range Итерируемый - это такой объект который
# предоставляет возможность поочередного прохода по своим Элементам !!!
