...
#  Замыканием называется когда наша вложенная функция пользуется переменными, которые не
#  обьявлены в ее теле  (от темы обычно все локальные переменные исчезнут после вызова , тут такого не происходит
